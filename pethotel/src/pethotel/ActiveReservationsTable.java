...
public class ActiveReservationsTable implements ListSelectionListener {
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (obj.equals(selectionModel)) {			
			System.out.println("ActiveReservationsTable notifying GUI: selected row=" + table.getSelectedRow());			
			ActionEvent ae = new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "ActiveReservationsTable");
